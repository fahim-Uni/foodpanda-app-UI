...
import 'package:flutter_food_panda_ui/compnents/restuarent.dart';
import 'package:flutter_food_panda_ui/constats/color.dart';
import 'package:flutter_food_panda_ui/constats/constants.dart';
import 'package:flutter_food_panda_ui/dashboard/home.dart';
import 'package:flutter_food_panda_ui/model/panda_pick_model/pandaPickHelper.dart';
import 'package:flutter_food_panda_ui/model/panda_pick_model/pandaPickItemModel.dart';
        ...
        child: Padding(
          ...
          child: Column(
           ...
           children: [
                         ...
                         Container(
                           ...
                           child: Padding(
                             ...
                             child: Column(
                               ...
                               crossAxisAlignment: CrossAxisAlignment.start,
                               children: [
                                 Text('Pick-Uo' , style: const TextStyle(color: blackColor , fontFamily: Bold, fontSize: 18 ),),
                                  Text('Upto 50% off' , style: const TextStyle(color: blackColor , fontWeight: FontWeight.w500 ,height:1 , fontFamily: Medium, fontSize: 14  )),
                         ...
                         Container(
                           ...
                           child: Padding(
                             ...
                             child: Column(
                               ...
                               crossAxisAlignment: CrossAxisAlignment.start,
                               children: [
                                 const Text('Shops' , style: TextStyle(color: blackColor , fontFamily: Bold, fontSize: 18 ),),
                                 const Text('Everyday assentials' , style: TextStyle(color: blackColor , fontWeight: FontWeight.w500 ,height:1 , fontFamily: Medium, fontSize: 14  )),
             ...
             const Text('Your daily deals' , style: TextStyle(color: const Color(0xff323232) , fontSize: 15, fontFamily: Bold),),
             Padding(
               padding: const EdgeInsets.symmetric(vertical: 10),
               child: Container(
        ...
        child: ListView(
          ...
          children: [
            const DrawerHeader(
              ...
              child: CircleAvatar(
                radius: 24,
                 backgroundImage: AssetImage("assets/faheemm.jpg"),
              ),
            ),
            ListTile(
